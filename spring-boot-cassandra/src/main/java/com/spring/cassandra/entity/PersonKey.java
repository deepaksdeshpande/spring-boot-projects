...
public class PersonKey implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4063838145499025495L;
	...
	public String toString() {
		return "PersonKey{" + "firstName='" + firstName + '\'' + ", dateOfBirth=" + dateOfBirth + ", id=" + id + '}';
	}
	...
	public boolean equals(Object o) {
		...
		if (dateOfBirth != null ? !dateOfBirth.equals(personKey.dateOfBirth) : personKey.dateOfBirth != null) {
			return false;
		}
